<template>
	<view>
		...
		<view style="margin: 30rpx 0;">
			<input focus="true" placeholder="输入用户名" v-model="account" style="background: #EEEEEE;padding: 20rpx 10rpx;height: 90rpx;margin: 0 50rpx;" />
	...
	export default {
		...
		methods: {
			...
			login(){
				var that = this
				uni.request({
						url: config.config.url+"/common/index/login",				
						method: 'POST',
						data: {
