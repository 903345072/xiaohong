	...
	export default{
		...
		methods:{
			launchFlow(){
				...
				var data = {"type":"basket","num":plzh.length,"checkGame":JSON.stringify(plzh),"bei":this.bei,"mode":1,"chuan":JSON.stringify(chuan_arr),"en_type":"竞彩篮球","money":plzh.length*this.bei*2,"check_game":plzh,"chuan_arr":chuan_arr}
				uni.navigateTo({
